...
gem "activesupport", "8.1.3.1" # For cache and notifications
...
group :test do
  ...
  gem "selenium-webdriver", "4.46.0" # Selenium WebDriver for browser testing
