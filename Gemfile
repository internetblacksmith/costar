...
gem "activesupport", "7.1.5.1" # For cache and notifications
...
group :test do
  ...
  gem "cucumber", "10.1.1" # BDD testing framework (Ruby 3.4+ compatible)
  ...
  gem "selenium-webdriver", "4.38.0" # Selenium WebDriver for accessibility testing
