...
gem "activesupport", "8.1.3" # For cache and notifications
...
gem "json", "2.19.3" # JSON parsing
gem "logger", "1.7.0" # Logging
gem "net-http", "0.9.1" # HTTP client
gem "nokogiri", "1.19.2" # XML parsing
gem "ostruct", "0.6.3" # OpenStruct
gem "puma", "8.0.0" # Web server
...
group :test do
  gem "axe-core-rspec", "4.11.2" # Accessibility testing with axe-core
