...
PEOPLE = ["Robert De Niro", "Joe Pesci", "Frank Vincent"].freeze
MOVIES = ["Goodfellas", "Casino", "Raging Bull", "The Irishman"].freeze
...
Dir.glob(File.join(proto_dir, "*.html")).each do |file|
